...
namespace IFramework.Infrastructure
{
    public partial class Repository<TEntity> where TEntity : EntityBase
    {
        ...
        /// <inheritdoc />
        public virtual async Task<bool> AddAsync(TEntity instance, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
               // instance.SetCreateAudit(instance.update_userid > 0 ? instance.update_userid : UserId);
        ...
        /// <inheritdoc />
        public virtual async Task<bool> AddAsync(IEnumerable<TEntity> instances, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<int> CountAsync(IDbTransaction transaction = null)
        {
            return await CountAsync(null, transaction);
        }

        /// <inheritdoc />
        public virtual async Task<int> CountAsync(Expression<Func<TEntity, bool>> predicate, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<int> CountAsync(Expression<Func<TEntity, object>> distinctField, IDbTransaction transaction = null)
        {
            return await CountAsync(distinctField, null, transaction);
        }

        /// <inheritdoc />
        public virtual async Task<int> CountAsync(Expression<Func<TEntity, object>> distinctField, Expression<Func<TEntity, bool>> predicate, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<bool> DeleteAsync(Expression<Func<TEntity, bool>> predicate, bool isLogicDelete = true, object updateUserId = null, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<bool> DeleteAsync(TEntity instance, bool isLogicDelete = true, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
                if (isLogicDelete)
        ...
        /// <inheritdoc />
        public virtual async Task<bool> UpdateAsync(TEntity instance, Expression<Func<TEntity, bool>> predicate, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
               // instance.SetUpdateAudit(instance.update_userid > 0 ? instance.update_userid : UserId);
        ...
        /// <inheritdoc />
        public virtual async Task<bool> UpdateAsync(IEnumerable<TEntity> instances, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
                var entities = instances.ToList();
        ...
        /// <inheritdoc />
        public virtual async Task<bool> UpdateAsync(Expression<Func<TEntity, TEntity>> updateValues, Expression<Func<TEntity, bool>> predicate, object updateUserId = null, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
                var userId = updateUserId ?? UserId;
        ...
        /// <inheritdoc />
        public virtual async Task<TEntity> GetAsync(Expression<Func<TEntity, bool>> predicate, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<TEntity> GetAsync(object id, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<IEnumerable<TEntity>> GetListAsync(Expression<Func<TEntity, bool>> predicate, IDbTransaction transaction = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<PagedList<TEntity>> GetPageListAsync(Expression<Func<TEntity, bool>> predicate, int pageIndex,
            int pageSize, string orderBy = null)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<IEnumerable<TEntity>> InAsync(IEnumerable<dynamic> keys)
        {
            return await _unitOfWork.Execute(async connection =>
            {
        ...
        /// <inheritdoc />
        public virtual async Task<IEnumerable<TEntity>> InAsync(Expression<Func<TEntity, object>> field, IEnumerable<dynamic> keys)
        {
            return await _unitOfWork.Execute(async connection =>
            {
                var objects = keys.ToList();
